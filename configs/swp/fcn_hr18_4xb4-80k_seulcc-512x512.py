...
checkpoint = dict(type="CheckpointHook", interval=1288,max_keep_ckpts=1)
vis_backends=[dict(type='LocalVisBackend'),
              dict(type='TensorboardVisBackend'),
              dict(type='WandbVisBackend',init_kwargs=dict(project='SEULCC'))
              ]
visualizer = dict(
    type="SegLocalVisualizer",
    vis_backends=vis_backends,
    save_dir='visual/seulcc',
    name="visualizer",
)
default_hooks = dict(
