...
# 最后切分好的potsdam的dir结构如下所示：
# img_dir: train/val/testFog
# dsm_dir: train/val/testFog
# ann_dir: train/val/testFog
# img_dsm_dir: train/val/testFog
#  其中的img_dir, dsm_dir为单一模态，img_dsm_dir为多模态数据
...
def main():
    ...
    splits = {
        'train': [
            ...
            '5_15', '6_15', '6_13', '3_13', '2_14', '4_15', '5_14', '4_13', '7_13'
        ],
        'val': [
            '2_13', '3_14', '4_14', '5_13', '6_14'
...
#%%
# 生成testFog文件夹
# 利用imagenet_c_created.py中生成雾气的方法来生成testFog中的数据

#%%
# 将生成好的img_dir, dsm_dir合并为img_dsm_dir
